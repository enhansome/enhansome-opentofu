...
* [OpenTofu repository](https://github.com/opentofu/opentofu) ⭐ 30,239 | 🐛 327 | 🌐 Go | 📅 2026-09-18 🎉
* [Weekly updates](https://github.com/opentofu/opentofu/discussions/categories/weekly-updates) ⭐ 30,239 | 🐛 327 | 🌐 Go | 📅 2026-09-18
* [Registry](https://github.com/opentofu/registry) ⭐ 410 | 🐛 12 | 🌐 Go | 📅 2026-09-20
* [Registry MCP Server](https://github.com/opentofu/opentofu-mcp-server#opentofu-mcp-server) ⭐ 109 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-04
* [Technical Steering Committee updates](https://github.com/opentofu/org/tree/main/TSC) ⭐ 4 | 🐛 10 | 📅 2026-09-16
...
* [arkade](https://github.com/alexellis/arkade) ⭐ 4,617 | 🐛 18 | 🌐 Go | 📅 2026-09-14 - CLI and Kubernetes app installer.
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,438 | 🐛 46 | 🌐 Go | 📅 2026-09-01 - Terraform and OpenTofu version manager written in Go.
* [tofuenv](https://github.com/tofuutils/tofuenv) ⭐ 238 | 🐛 21 | 🌐 Shell | 📅 2026-02-10 - OpenTofu version manager inspired by tfenv.
* [asdf-opentofu](https://github.com/virtualroot/asdf-opentofu) ⭐ 31 | 🐛 3 | 🌐 Shell | 📅 2026-09-08 - OpenTofu plugin for asdf version manager.
...
* [Terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,843 | 🐛 222 | 🌐 Go | 📅 2026-09-20 - Keep your configurations DRY, work with multiple modules, and manage remote state.
* [Terramate](https://github.com/terramate-io/terramate) ⭐ 3,631 | 🐛 101 | 🌐 Go | 📅 2026-09-08 - Automation, orchestration, and code generation for OpenTofu, Terraform, Kubernetes, and others.
* [Atmos](https://github.com/cloudposse/atmos) ⭐ 1,379 | 🐛 287 | 🌐 Go | 📅 2026-09-20 - Orchestration tool that keeps environment configuration DRY.
* [pug](https://github.com/leg100/pug) ⭐ 701 | 🐛 21 | 🌐 Go | 📅 2026-01-02 - A terminal user interface for power users.
* [tfwrapper](https://github.com/claranet/tfwrapper) ⭐ 155 | 🐛 9 | 🌐 Python | 📅 2026-09-17 - Python wrapper that simplifies OpenTofu usage and enforces best practices.
* [tf](https://github.com/dex4er/tf) ⭐ 88 | 🐛 15 | 🌐 Go | 📅 2026-09-20 - Less verbose and more friendly command outputs.
* [easy\_infra](https://github.com/SeisoLLC/easy_infra) ⭐ 78 | 🐛 6 | 🌐 Python | 📅 2026-09-18 - Docker container to simplify and secure the use of infrastructure as code.
...
* [tofu-controller](https://github.com/flux-iac/tofu-controller) ⭐ 1,698 | 🐛 162 | 🌐 Go | 📅 2026-09-14 - GitOps OpenTofu and Terraform controller for Flux.
* [terraform-github-actions](https://github.com/dflook/terraform-github-actions) ⭐ 984 | 🐛 28 | 🌐 Python | 📅 2026-09-10 - GitHub Actions for OpenTofu.
* [TF-via-PR](https://github.com/OP5dev/TF-via-PR) ⭐ 339 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-18 - GitHub Action to init, plan and apply Terraform/OpenTofu via PR automation.
* [setup-opentofu](https://github.com/opentofu/setup-opentofu) ⭐ 171 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-16 - Set up OpenTofu CLI in your GitHub Actions workflow.
* [pre-commit-opentofu](https://github.com/tofuutils/pre-commit-opentofu) ⭐ 100 | 🐛 0 | 🌐 Shell | 📅 2026-09-12 - Git pre-commit hooks plugin.
* [drifthound](https://github.com/treezio/drifthound) ⭐ 71 | 🐛 16 | 🌐 Ruby | 📅 2026-04-23 - Continuous infrastructure drift detection with historical tracking and notifications.
...
* [opentofu-updater-action](https://github.com/drumandbytes/opentofu-updater-action) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-20 - Keeps OpenTofu and Terraform providers, modules, Helm charts and container images up to date by opening pull requests.
...
* [Terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,947 | 🐛 8 | 🌐 Go | 📅 2026-09-19 - Go library that makes writing automated tests for your infrastructure code easier.

### State

*Analyze and manipulate OpenTofu's state.*

* [tfmigrate](https://github.com/minamijoyo/tfmigrate) ⭐ 1,277 | 🐛 23 | 🌐 Go | 📅 2026-05-04 - State migration tool.
* [tfimport](https://github.com/coolapso/tfimport) ⭐ 50 | 🐛 0 | 🌐 Go | 📅 2026-09-17 - Tool to automate state imports.

### Providers

*Inspect and interact with OpenTofu providers.*

* [tfschema](https://github.com/minamijoyo/tfschema) ⭐ 315 | 🐛 4 | 🌐 Go | 📅 2026-05-04 - Schema inspector for providers.

### Platforms

*Alternatives to Terraform Cloud.*

* [digger](https://github.com/diggerhq/digger) ⭐ 5,043 | 🐛 485 | 🌐 Go | 📅 2026-09-20 - Open-source IaC orchestration tool. Digger allows you to run IaC in your existing CI pipeline.
* [Terrateam](https://github.com/terrateamio/terrateam) ⭐ 1,282 | 🐛 113 | 🌐 OCaml | 📅 2026-09-19 - Open-source alternative to Terraform Cloud/Enterprise. GitOps-first and built for scale, security, and reliability across modern VCS providers.
* [terrakube](https://github.com/AzBuilder/terrakube) ⭐ 963 | 🐛 128 | 🌐 Java | 📅 2026-09-20 - Open-source platform with a private registry, remote state, custom flows, scheduled workspaces, and visual states.
...
* [terralist](https://github.com/terralist/terralist) ⭐ 520 | 🐛 21 | 🌐 Go | 📅 2026-09-19 - Private registry for providers and modules.
...
* [boring-registry](https://github.com/boring-registry/boring-registry) ⭐ 293 | 🐛 28 | 🌐 Go | 📅 2026-09-14 - An open-source module and provider registry compatible with OpenTofu.
* [tapir](https://github.com/PacoVK/tapir) ⭐ 239 | 🐛 36 | 🌐 Java | 📅 2026-09-10 - Private registry for modules and providers with a UI.
* [terraform-registry](https://github.com/nrkno/terraform-registry) ⭐ 118 | 🐛 19 | 🌐 Go | 📅 2026-09-14 - Modules registry with authentication and support for multiple backends.
...
* [tofuref](https://github.com/djetelina/tofuref) ⭐ 28 | 🐛 2 | 🌐 Python | 📅 2026-07-23 - TUI for OpenTofu provider registry.
...
* [terratag](https://github.com/env0/terratag) ⭐ 1,056 | 🐛 2 | 🌐 Go | 📅 2026-09-10 - CLI tool allowing for tags or labels to be applied across an entire set of OpenTofu/Terraform files.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/opentofu) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-20 - Security-focused Terraform dev container with terraform-ls and rebuild-friendly caching. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/opentofu) ⭐ 2 | 🐛 1 | 🌐 Shell | 📅 2026-09-20.
