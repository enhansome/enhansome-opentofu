...
* [OpenTofu repository](https://github.com/opentofu/opentofu) ⭐ 29,775 | 🐛 344 | 🌐 Go | 📅 2026-08-13 🎉
* [Weekly updates](https://github.com/opentofu/opentofu/discussions/categories/weekly-updates) ⭐ 29,775 | 🐛 344 | 🌐 Go | 📅 2026-08-13
* [Registry](https://github.com/opentofu/registry) ⭐ 407 | 🐛 18 | 🌐 Go | 📅 2026-08-13
* [Registry MCP Server](https://github.com/opentofu/opentofu-mcp-server#opentofu-mcp-server) ⭐ 107 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-15
* [Technical Steering Committee updates](https://github.com/opentofu/org/tree/main/TSC) ⭐ 4 | 🐛 9 | 📅 2026-08-04
...
* [arkade](https://github.com/alexellis/arkade) ⭐ 4,604 | 🐛 18 | 🌐 Go | 📅 2026-08-13 - CLI and Kubernetes app installer.
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,427 | 🐛 46 | 🌐 Go | 📅 2026-07-25 - Terraform and OpenTofu version manager written in Go.
...
* [Terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,777 | 🐛 224 | 🌐 Go | 📅 2026-08-13 - Keep your configurations DRY, work with multiple modules, and manage remote state.
* [Terramate](https://github.com/terramate-io/terramate) ⭐ 3,619 | 🐛 103 | 🌐 Go | 📅 2026-07-31 - Automation, orchestration, and code generation for OpenTofu, Terraform, Kubernetes, and others.
* [Atmos](https://github.com/cloudposse/atmos) ⭐ 1,353 | 🐛 302 | 🌐 Go | 📅 2026-08-13 - Orchestration tool that keeps environment configuration DRY.
* [pug](https://github.com/leg100/pug) ⭐ 691 | 🐛 21 | 🌐 Go | 📅 2026-01-02 - A terminal user interface for power users.
* [tfwrapper](https://github.com/claranet/tfwrapper) ⭐ 155 | 🐛 10 | 🌐 Python | 📅 2026-08-13 - Python wrapper that simplifies OpenTofu usage and enforces best practices.
* [tf](https://github.com/dex4er/tf) ⭐ 89 | 🐛 9 | 🌐 Go | 📅 2026-08-13 - Less verbose and more friendly command outputs.
* [easy\_infra](https://github.com/SeisoLLC/easy_infra) ⭐ 78 | 🐛 6 | 🌐 Python | 📅 2026-08-13 - Docker container to simplify and secure the use of infrastructure as code.
...
* [tofu-controller](https://github.com/flux-iac/tofu-controller) ⭐ 1,681 | 🐛 154 | 🌐 Go | 📅 2026-08-10 - GitOps OpenTofu and Terraform controller for Flux.
...
* [TF-via-PR](https://github.com/OP5dev/TF-via-PR) ⭐ 335 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-13 - GitHub Action to init, plan and apply Terraform/OpenTofu via PR automation.
* [setup-opentofu](https://github.com/opentofu/setup-opentofu) ⭐ 168 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-04 - Set up OpenTofu CLI in your GitHub Actions workflow.
...
* [tofUI](https://github.com/65156/tofUI) ⭐ 4 | 🐛 0 | 🌐 HTML | 📅 2026-07-17 - Easily export OpenTofu and Terraform plans in HTML for better readability.
...
* [Terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,942 | 🐛 1 | 🌐 Go | 📅 2026-08-13 - Go library that makes writing automated tests for your infrastructure code easier.
...
* [digger](https://github.com/diggerhq/digger) ⭐ 5,019 | 🐛 478 | 🌐 Go | 📅 2026-08-11 - Open-source IaC orchestration tool. Digger allows you to run IaC in your existing CI pipeline.
* [Terrateam](https://github.com/terrateamio/terrateam) ⭐ 1,259 | 🐛 159 | 🌐 OCaml | 📅 2026-08-13 - Open-source alternative to Terraform Cloud/Enterprise. GitOps-first and built for scale, security, and reliability across modern VCS providers.
* [terrakube](https://github.com/AzBuilder/terrakube) ⭐ 944 | 🐛 114 | 🌐 Java | 📅 2026-08-13 - Open-source platform with a private registry, remote state, custom flows, scheduled workspaces, and visual states.
...
* [terralist](https://github.com/terralist/terralist) ⭐ 512 | 🐛 22 | 🌐 Go | 📅 2026-08-13 - Private registry for providers and modules.
...
* [boring-registry](https://github.com/boring-registry/boring-registry) ⭐ 290 | 🐛 27 | 🌐 Go | 📅 2026-08-12 - An open-source module and provider registry compatible with OpenTofu.
* [tapir](https://github.com/PacoVK/tapir) ⭐ 238 | 🐛 33 | 🌐 Java | 📅 2026-08-12 - Private registry for modules and providers with a UI.
* [terraform-registry](https://github.com/nrkno/terraform-registry) ⭐ 118 | 🐛 17 | 🌐 Go | 📅 2026-08-10 - Modules registry with authentication and support for multiple backends.
* [terustry](https://github.com/veepee-oss/terustry) ⭐ 73 | 🐛 0 | 🌐 Rust | 📅 2024-08-13 - Proxy registry for providers.
* [hermitcrab](https://github.com/seal-io/hermitcrab) ⭐ 49 | 🐛 5 | 🌐 Go | 📅 2025-11-20 - Registry network mirroring service compatible with OpenTofu.
...
* [OpenTofu Language Server](https://github.com/opentofu/tofu-ls) ⭐ 182 | 🐛 12 | 🌐 Go | 📅 2026-07-08 - The OpenTofu Language Server.
