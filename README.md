...
* [OpenTofu repository](https://github.com/opentofu/opentofu) ⭐ 30,118 | 🐛 314 | 🌐 Go | 📅 2026-09-07 🎉
* [Weekly updates](https://github.com/opentofu/opentofu/discussions/categories/weekly-updates) ⭐ 30,118 | 🐛 314 | 🌐 Go | 📅 2026-09-07
* [Registry](https://github.com/opentofu/registry) ⭐ 408 | 🐛 57 | 🌐 Go | 📅 2026-09-07
...
* [arkade](https://github.com/alexellis/arkade) ⭐ 4,614 | 🐛 17 | 🌐 Go | 📅 2026-09-07 - CLI and Kubernetes app installer.
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,433 | 🐛 45 | 🌐 Go | 📅 2026-09-01 - Terraform and OpenTofu version manager written in Go.
* [tofuenv](https://github.com/tofuutils/tofuenv) ⭐ 236 | 🐛 21 | 🌐 Shell | 📅 2026-02-10 - OpenTofu version manager inspired by tfenv.
* [asdf-opentofu](https://github.com/virtualroot/asdf-opentofu) ⭐ 31 | 🐛 4 | 🌐 Shell | 📅 2026-09-06 - OpenTofu plugin for asdf version manager.
...
* [Terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,819 | 🐛 240 | 🌐 Go | 📅 2026-09-07 - Keep your configurations DRY, work with multiple modules, and manage remote state.
* [Terramate](https://github.com/terramate-io/terramate) ⭐ 3,623 | 🐛 102 | 🌐 Go | 📅 2026-09-07 - Automation, orchestration, and code generation for OpenTofu, Terraform, Kubernetes, and others.
* [Atmos](https://github.com/cloudposse/atmos) ⭐ 1,372 | 🐛 284 | 🌐 Go | 📅 2026-09-07 - Orchestration tool that keeps environment configuration DRY.
* [pug](https://github.com/leg100/pug) ⭐ 700 | 🐛 21 | 🌐 Go | 📅 2026-01-02 - A terminal user interface for power users.
* [tfwrapper](https://github.com/claranet/tfwrapper) ⭐ 155 | 🐛 9 | 🌐 Python | 📅 2026-09-07 - Python wrapper that simplifies OpenTofu usage and enforces best practices.
* [tf](https://github.com/dex4er/tf) ⭐ 88 | 🐛 13 | 🌐 Go | 📅 2026-09-07 - Less verbose and more friendly command outputs.
...
* [setup-opentofu](https://github.com/opentofu/setup-opentofu) ⭐ 170 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-07 - Set up OpenTofu CLI in your GitHub Actions workflow.
...
* [Terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,943 | 🐛 9 | 🌐 Go | 📅 2026-09-07 - Go library that makes writing automated tests for your infrastructure code easier.
...
* [digger](https://github.com/diggerhq/digger) ⭐ 5,041 | 🐛 482 | 🌐 Go | 📅 2026-08-11 - Open-source IaC orchestration tool. Digger allows you to run IaC in your existing CI pipeline.
* [Terrateam](https://github.com/terrateamio/terrateam) ⭐ 1,281 | 🐛 111 | 🌐 OCaml | 📅 2026-09-07 - Open-source alternative to Terraform Cloud/Enterprise. GitOps-first and built for scale, security, and reliability across modern VCS providers.
* [terrakube](https://github.com/AzBuilder/terrakube) ⭐ 959 | 🐛 116 | 🌐 Java | 📅 2026-09-07 - Open-source platform with a private registry, remote state, custom flows, scheduled workspaces, and visual states.
...
* [boring-registry](https://github.com/boring-registry/boring-registry) ⭐ 292 | 🐛 28 | 🌐 Go | 📅 2026-09-04 - An open-source module and provider registry compatible with OpenTofu.
