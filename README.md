...
* [OpenTofu repository](https://github.com/opentofu/opentofu) ⭐ 29,789 | 🐛 340 | 🌐 Go | 📅 2026-08-14 🎉
* [Weekly updates](https://github.com/opentofu/opentofu/discussions/categories/weekly-updates) ⭐ 29,789 | 🐛 340 | 🌐 Go | 📅 2026-08-14
* [Registry](https://github.com/opentofu/registry) ⭐ 407 | 🐛 13 | 🌐 Go | 📅 2026-08-14
...
* [arkade](https://github.com/alexellis/arkade) ⭐ 4,605 | 🐛 18 | 🌐 Go | 📅 2026-08-14 - CLI and Kubernetes app installer.
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,428 | 🐛 47 | 🌐 Go | 📅 2026-07-25 - Terraform and OpenTofu version manager written in Go.
...
* [Terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,775 | 🐛 230 | 🌐 Go | 📅 2026-08-14 - Keep your configurations DRY, work with multiple modules, and manage remote state.
* [Terramate](https://github.com/terramate-io/terramate) ⭐ 3,621 | 🐛 103 | 🌐 Go | 📅 2026-07-31 - Automation, orchestration, and code generation for OpenTofu, Terraform, Kubernetes, and others.
* [Atmos](https://github.com/cloudposse/atmos) ⭐ 1,355 | 🐛 299 | 🌐 Go | 📅 2026-08-14 - Orchestration tool that keeps environment configuration DRY.
* [pug](https://github.com/leg100/pug) ⭐ 692 | 🐛 21 | 🌐 Go | 📅 2026-01-02 - A terminal user interface for power users.
* [tfwrapper](https://github.com/claranet/tfwrapper) ⭐ 155 | 🐛 10 | 🌐 Python | 📅 2026-08-14 - Python wrapper that simplifies OpenTofu usage and enforces best practices.
* [tf](https://github.com/dex4er/tf) ⭐ 89 | 🐛 9 | 🌐 Go | 📅 2026-08-14 - Less verbose and more friendly command outputs.
...
* [tofu-controller](https://github.com/flux-iac/tofu-controller) ⭐ 1,682 | 🐛 154 | 🌐 Go | 📅 2026-08-10 - GitOps OpenTofu and Terraform controller for Flux.
...
* [tofUI](https://github.com/65156/tofUI) ⭐ 4 | 🐛 1 | 🌐 HTML | 📅 2026-08-14 - Easily export OpenTofu and Terraform plans in HTML for better readability.
...
* [Terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,941 | 🐛 1 | 🌐 Go | 📅 2026-08-13 - Go library that makes writing automated tests for your infrastructure code easier.
...
* [digger](https://github.com/diggerhq/digger) ⭐ 5,018 | 🐛 478 | 🌐 Go | 📅 2026-08-11 - Open-source IaC orchestration tool. Digger allows you to run IaC in your existing CI pipeline.
* [Terrateam](https://github.com/terrateamio/terrateam) ⭐ 1,259 | 🐛 159 | 🌐 OCaml | 📅 2026-08-14 - Open-source alternative to Terraform Cloud/Enterprise. GitOps-first and built for scale, security, and reliability across modern VCS providers.
* [terrakube](https://github.com/AzBuilder/terrakube) ⭐ 944 | 🐛 113 | 🌐 Java | 📅 2026-08-14 - Open-source platform with a private registry, remote state, custom flows, scheduled workspaces, and visual states.
...
* [terralist](https://github.com/terralist/terralist) ⭐ 512 | 🐛 22 | 🌐 Go | 📅 2026-08-14 - Private registry for providers and modules.
